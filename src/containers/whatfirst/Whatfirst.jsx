...
import './whatfirst.css';

const Whatfirst = () => {
  return (
    <div className='first__whatfirst section__margin' id='whatfirst'>
      <div className='first__whatfirst-feature'>
      ...
      <div className='first__whatfirst-heading'>
         <h1 className='gradient__text'> The possibilities are beyond your imagination</h1>
         <p>Explore The Library</p>
      </div>
      <div className='first__whatfirst-container'>
